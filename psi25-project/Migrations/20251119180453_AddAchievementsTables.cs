        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalGuesses = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    TotalGames = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    BestGameScore = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    CurrentStreakDays = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    LastPlayedDateUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
